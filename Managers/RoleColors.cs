...
{
    /// <summary>
    /// Per-role colours sourced directly from TOUM's TownOfUsColors class.
    /// Used to tint draft cards on hover.
    /// </summary>
    public static class RoleColors
    {
        // Fallback faction colours used when a role has no specific entry
        public static readonly Color CrewFallback     = new Color32(75,  215, 228, 255); // #4BD7E4
        public static readonly Color ImpostorFallback = new Color32(255, 70,  70,  255); // #FF4646
        public static readonly Color NeutralFallback  = new Color32(171, 70,  255, 255); // #AB46FF
        public static readonly Color RandomColour     = new Color32(59,  204, 59,  255); // green
        ...
        public static Color GetColor(string roleName)
        {
            return roleName.Replace(" ", "").ToLowerInvariant() switch
            {
                ...
                // ── Impostor (all share the impostor red family) ───────────────
